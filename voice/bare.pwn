...
public OnPlayerConnect(playerid) {
	...
	if (!SvGetVersion(playerid)) SendClientMessage(playerid, -1, "Could not find plugin sampvoice.");
	else if (!SvHasMicro(playerid)) SendClientMessage(playerid, -1, "The microphone could not be found.");
